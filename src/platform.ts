...
import { SolisBatteryAccessory } from './accesory';
 ...
 */
export class SolisSensorPlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    if (existingAccessory) {
      ...
      new SolisBatteryAccessory(this, existingAccessory);
      ...
      // this is imported from `platformAccessory.ts`
      new SolisBatteryAccessory(this, accessory);
